...
creds = ServiceAccountCredentials.from_json_keyfile_name('C:\Users\sansk\Downloads\evocative-shore-417308-e617b5ec9771.json', scope)
...
# Read the CSV files
csv_files = ['C:\ProgramData\Jenkins\.jenkins\workspace\GreenCodeScanPipeline\emissions_data.csv', 'C:\ProgramData\Jenkins\.jenkins\workspace\GreenCodeScanPipeline\server_data.xlsx']
